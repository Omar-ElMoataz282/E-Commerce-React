...
function ProductCard(props) {
  ...
  const finalPrice = props.price - props.sale;

  return (
    <NavLink
      to={`/product/${props.id}`}
      className="col-lg-3 col-md-6 col-sm-6 col-10 text-black"
    >
      <div className="m-1 border rounded p-3 h-100 d-flex flex-column justify-content-between pro-card-center">
        <div>
          ...
          <div className="px-2 pt-4 position-relative">
            {props.sale > 0 && (
        ...
        <div className="d-flex align-items-center justify-content-between border-top pt-3">
          <div>
            ...
            <div className="d-flex align-items-center gap-3">
              <h5 className="m-0 text-primary">{finalPrice}</h5>
              <h6 className="m-0 del-price">{props.sale > 0 && props.price}</h6>
            </div>
          </div>
